...
; Major changes from the last version (v3.0)
; 1) Created a button "sediment-chg-order" to choose between the two functions of sediment-change-in-order and 
;    sediment-change-no-order. The default is on (using sediment-change-in-order)
;    
